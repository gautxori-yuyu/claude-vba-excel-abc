...
Attribute GetLevelName.VB_Description = "[modLogger] UTILIDADES.  Obtiene el nombre del nivel de log"
...
Attribute GetLogFilePath.VB_Description = "[modLogger] Obtiene la ruta del archivo de log actual"
