Class cOportunidad
	...
	Function Init (strOpFolder, ExcelApp, MsgIE_)
		Set Init = Me
		...
		Set oOp_CalcsTecn = (New cOp_CalcsTecn).Init(strOpFolder & "\2.CALCULO TECNICO", ExcelApp)
	...
	Function procesaCarp()
	    ...
	    If Err.Number <> 0 Then
	        MsgLog "Error procesando cálculos técnicos: " & Err.Description
	        Err.Clear
	    End If
