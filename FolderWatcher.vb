...
<ComVisible(True)>
<Guid("E5G7B9D4-2222-4CDE-BC12-1234567890AC")>
...
<ComVisible(True)>
<Guid("F6H8C0E5-3333-4CDE-BC12-1234567890AD")>
...
' =====================================================
    ...
    Public Sub WatchFolder(folderPath As String,
        ...
        AddHandler fsw.Error, Sub(s As Object, e As ErrorEventArgs)
                                  Dim errMsgInterno As String = String.Format("Error en FileSystemWatcher: {0}", e.GetException().Message)
