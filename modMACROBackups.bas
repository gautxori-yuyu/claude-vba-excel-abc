Attribute VB_Name = "modMACROBackups"
' ==========================================
...
' ==========================================
' ALTERNATIVA: FUNCIÓN CON MANEJO EXPLÍCITO
' ==========================================
' Si prefieres tener control manual del estado IsAddin

'@Description: Activa temporalmente la visibilidad del XLAM para operaciones de copia
'@Scope: Privado
'@Returns: Boolean | Estado anterior de IsAddin
Private Function DesactivarModoAddin() As Boolean
    On Error Resume Next
    DesactivarModoAddin = ThisWorkbook.IsAddin
    If DesactivarModoAddin Then
...
'@Scope: Privado
'@ArgumentDescriptions: estadoAnterior: Estado a restaurar (True/False)
Private Sub RestaurarModoAddin(estadoAnterior As Boolean)
    On Error Resume Next
...
Private Function CrearBackupHojaExcel_V2(ws As Worksheet) As Boolean
    ...
    Dim wsBackup As Worksheet
    Dim respuesta As VbMsgBoxResult
    Dim estadoAddinAnterior As Boolean
    ...
    estadoAddinAnterior = DesactivarModoAddin()
    ...
    Call RestaurarModoAddin(estadoAddinAnterior)
