...
Public Const CFG_RUTA_PLCALCNACE As String = "C:\abc compressors\INTRANET\OficiónaTecnica\Documentacion\Normas\NACE\Herramienta\Herramienta_para_seleccion_de_materiales_v1.4.xlsx"
